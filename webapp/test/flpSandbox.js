		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Veterinary",
									"targetURL": "#accveterinary-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"accveterinary-display": {
								"semanticObject": "accveterinary",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=acc.veterinary",
									"url": sap.ui.require.toUrl("acc/veterinary")
								}
							}
						}
					}
